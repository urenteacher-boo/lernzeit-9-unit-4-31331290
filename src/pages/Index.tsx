        ...
        <div className="p-8 lg:p-12 max-w-7xl mx-auto">
          <header className="flex justify-between items-center mb-8">
            <div className="flex gap-8 items-center">
              ...
              <button className="text-stone-olive font-medium hover:text-olive transition text-sm">Resources</button>
              <button className="text-stone-olive font-medium hover:text-olive transition text-sm">Community</button>
            </div>
            <div className="flex items-center gap-3">
              <button className="p-2 text-stone-olive hover:text-olive transition">
          ...
          <section className="relative mb-16 h-[380px] rounded-[2rem] overflow-hidden shadow-2xl bg-gradient-hero group">
          ...
          <section className="mb-20">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {WEEKS.map((w) => (
                <button
                  key={w.n}
                  onClick={() => w.n === 1 ? navigate("/week/1") : undefined}
